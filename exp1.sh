...
# test v2 [trained for very very long time]
git checkout main
python3 DDM_test.py -p test -c config/DDM_test_b8_v2.json #experiments/DDM_test_240223_161148/results
python3 DDM_test.py -p test -c config/DDM_test_b8_motion_nooe_v2.json
